...
<script type="text/javascript" src="inc/initcolumn/wddd_gys_y.js"></script>
		...
		datagrid = $("#dataGrid").datagrid(
				{
					...
					queryParams: { PMMUD02: eps.PMMUD02_t },
		...
		$('#statuschange').dialog({
			buttons : [ {
				...
				handler : function() {
					...
					$.get("users/checkrole2", { accid1: eps.ACCID, accid2: eps.rowDate.accid },
							  function(data){
		...
		<form id="searchform"
			...
			<table class="tableForm">
				<tr>
					...
					<td><input id="PMM04" name="PMM04" class="easyui-datebox" /></td>
...
<!--  SIZE弹窗-->
	...
	<div id="dlgft" style="padding: 2px 5px; display: none;">
