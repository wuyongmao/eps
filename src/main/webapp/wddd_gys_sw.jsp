...
<script type="text/javascript">
	...
	wddd_gys_z.doSearch = function() {
		...
		opts.url = "${pageContext.request.contextPath }/wxb/getwxb1"; //ds
		$("#dg").datagrid("load", ob
...
<body>
			...
			<form id="searchform"
				...
				<table class="tableForm">
					<tr>
						...
						<td><span>箱号</span></td>
						<td><input id="WXB05" name="WXB05" class="easyui-textbox" /></td>
	...
	<script type="text/javascript">
		...
		function onClickCell(index, field) {
			...
			eps.openwdwddd_gys_dialog_size2(index, field, selectedrow);
		...
		function acceptdata(op, ob) {
			...
			$.each(ob, function(i, n) {
				...
				row.WXB05 = $.trim(n.WXB05);
				row.WXB06 = $.trim(n.WXB06);
				row.WXB07 = $.trim(n.WXB07);
				row.WXB08 = n.WXB08;
				row.WXB09 = n.WXB09;
				row.WXB10 = n.WXB10;
				row.WXB14 = $.trim(n.WXB14);
				row.WXB15 = $.trim(n.WXB15);
				row.op = op;
				row.ROLE = eps.ROLE;
				row.flag = 'imp';
				//----------------------------提交新增/更新
