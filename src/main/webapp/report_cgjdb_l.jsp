...
<script type="text/javascript" src="inc/initcolumn/report_cgjdb_l.js"></script>

<link rel="stylesheet" type="text/css" href="inc/css/baseCss.css"></link>



<title>采购进度表(量产)</title>

<script type="text/javascript">
	var report_cgjdb_l = $.extend({}, report_cgjdb_l);/* 全局对象 */
	var selectedrow;
	var editIndex = undefined;
	var type="rl";
	$(function() {
		var column_report_cgjdb_l_PMM_PMN = []; //采购主明细档

		column_report_cgjdb_l_PMM_PMN = initcolumn();
		var datagrid; //定义全局变量  
		...
		datagrid = $("#dataGrid").datagrid(
				{
					...
					// fitColumns:true,
					columns : [ column_report_cgjdb_l_PMM_PMN ],
					toolbar : "#toolstb",
	...
	report_cgjdb_l.doSearch = function() {
	...
	report_cgjdb_l.remove = function() {
		$("#searchform").form('clear');
	};
	report_cgjdb_l.add = function() {
		...
		<form id="searchform"
			...
			<table class="tableForm">
				...
				<tr>
					...
					<td><span>未交数量</span></td>
					<td><input id="CJL" name="CJL" class="easyui-textbox" /></td>
					...
					<td><div class="easyui-linkbutton" iconCls="icon-search"
							plain="true" onclick="report_cgjdb_l.doSearch()">查询</div></td>

					<td><div class="easyui-linkbutton" iconCls="icon-clear"
							onclick=" report_cgjdb_l.remove()">清空</div></td>
				</tr>
