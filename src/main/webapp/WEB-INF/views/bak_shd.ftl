...
LODOP.SET_PRINT_PAGESIZE(1,9000,9000,"");
LODOP.NewPage(); 

LODOP.ADD_PRINT_HTM(100, 40, "90%", "80%", document.getElementById("main").innerHTML  );
console.info( document.getElementById("main").innerHTML );
