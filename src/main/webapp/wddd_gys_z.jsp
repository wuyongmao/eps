...
<script type="text/javascript" src="inc/initcolumn/wddd_gys_z.js"></script>
	...
	$(function() {
		...
		datagrid = $("#dataGrid").datagrid({
			...
			onDblClickCell : function(index, field, value) {
				...
				//eps.openwdwddd_gys_dialog_zl(index, field, selectedrow);
				$.getJSON("/eps/wxb/getwxb?PMN01=" + selectedrow.PMN01 + "&PMN02=" + selectedrow.PMN02, function(data) {
					if (data != undefined) {
						if (data.rows[0] != undefined) {
							$("#wxbform :input").attr("disabled", "disabled");
							$('#wxbform').form('load', data.rows[0]);
						}
					}
